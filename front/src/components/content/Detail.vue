      ...
      <div class="layui-col-md8 content detail">
        <div class="fly-panel detail-box">
          ...
          <div class="fly-detail-info">
            ...
            <span
              ...
              v-if="page.catalog === 'share'">分享</span>
            <span
              class="layui-badge layui-bg-green fly-detail-column"
            ...
            <span
              class="layui-badge layui-bg-green fly-detail-column"
              v-else-if="page.catalog === 'logs'">动态</span>
            <span
              class="layui-badge layui-bg-green fly-detail-column"
          ...
          <div class="layui-btn-container fly-detail-admin pt1">
            <router-link
              ...
              v-show="page.isEnd === '0' && page.uid._id === user._id">编辑</router-link>
            <a
        ...
        <div class="fly-panel detail-box" id="flyReply">
          ...
          <ktn-page
            ...
            @changeLimit="handleLimit"></ktn-page>
          <div class="layui-form layui-form-pane">
            <form>
              <validation-observer ref="observer" v-slot="{ validate }">
                <ktn-edit @changeContent="addContent" :init-content="editInfo.content"></ktn-edit>

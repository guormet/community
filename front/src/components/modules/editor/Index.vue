<template>
  <div class="edit-wrap">
    ...
    <div ref="modal">
      <face :is-show="current === 0" @closeEvent="closeModal()" @addEvent="addFace"></face>
      <img-upload :is-show="current === 1" @closeEvent="closeModal()" @addEvent="addPic"></img-upload>
      <link-add :is-show="current === 2" @closeEvent="closeModal()" @addEvent="addLink"></link-add>
      <quote :is-show="current === 3" @closeEvent="closeModal()" @addEvent="addQuote"></quote>
      <code-input
        :is-show="current === 4"
        :width="codeWidth"
        :height="codeHeight"
      ...
      <preview :is-show="current === 6" :content="content" @closeEvent="closeModal()"></preview>
    </div>
  </div>
</template>
